...
namespace QLNS_TinhVanSoftWare.PresentationLayer
{
    public partial class frmPhongBan : Form
    {
        ...
        {
            //txtTenCV.Text = dgvPhongban.CurrentRow.Cells[3].Value.ToString() + " - " + dgvPhongban.CurrentRow.Cells[4].Value.ToString();
            //txtHSL.Text = dgvPhongban.CurrentRow.Cells[5].Value.ToString();

        }

        private void btnDelete_Click(object sender, EventArgs e)
        {
            //string b = txtTenCV.Text;
        ...
        {
            //loadData(phongBanBLL.searchById(txtTenCV.Text));
        }
